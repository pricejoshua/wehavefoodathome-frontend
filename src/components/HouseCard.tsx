...
function HouseCard({ name, image }: HouseCardProps) {
  return (
    <Link to={`/house/${name}`} className="flex flex-col justify-center items-center bg-dun-600 shadow-lg rounded-lg overflow-hidden my-4 mx-2 min-w-72 min-h-36 transition-all hover:scale-110 hover:shadow-xl">
      <div className="p-4">
